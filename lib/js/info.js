...
const generalInfo = (selection, casesPerCapita, dailyIncrease100k, weeklyIncreasePerCapita) => {
...
const info = (selection, covidData, casesPerCapita, dailyIncrease100k, weeklyIncreasePerCapita, guidelineData) => {
    if (selection.cases) {
        hideAbout();
        $('.info-container').css({
            'display': 'block'
        ...
        generalInfo(selection, casesPerCapita, dailyIncrease100k, weeklyIncreasePerCapita);
