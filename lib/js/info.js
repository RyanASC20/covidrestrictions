...
const generalInfo = selection => {
    ...
    $('.info-general')
        .html(
            `<p>Population: <span class="quick-info">${parseInt(selection.population).toLocaleString()}</span></p>
            <p>Cases Per Capita: <span class="quick-info">${selection.casesPerCapita}</span></p>
            <p>Daily Increase/100k: <span class="quick-info">${selection.dailyIncrease100k}</span></p>
            <p>Weekly Increase Per Capita: <span class="quick-info">${selection.weeklyIncreasePerCapita}</span></p>`
        )
